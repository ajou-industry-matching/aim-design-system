...
const SpecBadge = ({ num }: { num: number }) => (
  <span className="inline-flex items-center justify-center w-6 h-6 bg-blue-600 text-white rounded-full text-[11px] font-bold ml-2 z-50 relative">
    {num}
  </span>
);
...
export default function LoginPageFigma() {
  const [activeTab, setActiveTab] = useState<"ajou" | "company">("ajou");
                        ...
                        {!isSignup ? (
                          ...
                          >
                            ...
                            <div className="flex flex-col gap-3">
                              ...
                              <Button
                                type="submit"
                                className="flex-1 h-[48px] bg-[#003876] hover:bg-[#003876]/90 text-white rounded-[8px] text-[16px] font-medium leading-[1.5] tracking-[-0.4px]"
                              >
                                로그인
                              </Button>
                              <SpecBadge num={9} />
                          ...
                          >
                            <div className="flex flex-col gap-4">
                              {/* Fields omitted for brevity in Login spec if focusing on login, but keeping for completeness since user can switch */}
                               <div className="relative">
                                <Input
                                  type="text"
                                  placeholder="회사명"
                              ...
                              <div className="p-4 border border-dashed border-gray-300 rounded text-center text-gray-400">
                                (Signup Fields same style as Login)
                              </div>
                            </div>
        ...
        <div className="w-[450px] p-8 bg-blue-50 border-l-4 border-blue-500">
          ...
          />
           <SpecDetail
            ...
            className="h-[48px] pl-12 pr-4 border border-[#ccc] rounded-[8px] text-[16px]"
            label="Input Field"
            note="Includes Icon positioning"
          />
          <SpecDetail
            num={9}
            className="w-full h-[48px] bg-[#003876] hover:bg-[#003876]/90 text-white rounded-[8px] text-[16px] font-medium leading-[1.5] tracking-[-0.4px]"
