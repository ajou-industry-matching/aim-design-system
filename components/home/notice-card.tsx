...
export function NoticeCard({
  ...
  return (
    <Link href={`/notice/${id}`} className="block group">
      <div className="bg-white border border-[#e5e5e5] flex flex-col gap-4 p-6 rounded-xl hover:border-[#003876] transition-colors">
        {/* Badge */}
        <div className="flex">
          <span className="border border-[#003876] text-[#003876] text-[12px] font-medium leading-[1.33] tracking-[-0.3px] px-3 py-1 rounded-xl">
            {badge}
          </span>
        </div>
